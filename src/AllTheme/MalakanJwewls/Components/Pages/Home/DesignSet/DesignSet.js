...
const DesignSet = () => {
    ...
    return (
        <div className="mala_designSetMain">

            <p className='mala_desognSetTitle'>Complete Your Look
                <Link className='mala_designSetViewmoreBtn' onClick={handleNavigate}>
                    View more
                </Link>
            </p>
            <div className='mala_designSetMainDiv'>
                <div className='mala_designSetDiv1'>
                    <img className="mala_designSetDiv1_img" loading="lazy" src={`${imageUrl}${designSetList[0]?.designsetuniqueno}/${designSetList[0]?.DefaultImageName}`} onClick={() => handleNavigation(designSetList[0]?.designno, designSetList[0]?.autocode, designSetList[0]?.TitleLine ? designSetList[0]?.TitleLine : '')} />
                </div>
                <div className='mala_designSetDiv2'>
                    ...
                    {!showAll && itemsToShow?.length > 6 && (
                        <p className='mala_designSetImageViewAll' onClick={handleViewAll}>View All</p>
                    )}
                </div>
...
//     return (
//         <div className='mala_designSetMain' style={{ position: 'relative' }}>
//             <div>
...
//                             <div className='mala_designsetDiv'>
//                                 <div className='mala_designsetDivImg'>
...
//             <p className='mala_designSetShowAll'>View All</p>
//         </div>
//     )
// }
