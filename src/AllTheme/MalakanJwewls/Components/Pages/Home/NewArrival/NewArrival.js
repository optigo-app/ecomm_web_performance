    ...
    return (
        <div>
            {newArrivalData?.length != 0 &&
                <div className='mala_NewArrivalMain'>
...
//                         <div className='mala_newArrivaldivMain'>
//                             <div className='mala_newArrialDiv1' onClick={() => handleNavigation(newArrivalData[0]?.designno, newArrivalData[0]?.autocode, newArrivalData[0]?.TitleLine)}>
...
//                                 <p className='mala_nwArrivalTitle'>{newArrivalData[0]?.TitleLine}</p>
//                                 <p className='mala_nwArrivalTitle'><span
...
//                             </div>
//                             <div className='mala_newArrialDiv1' onClick={() => handleNavigation(newArrivalData[1]?.designno, newArrivalData[1]?.autocode, newArrivalData[1]?.TitleLine)}>
...
//                                 <p className='mala_nwArrivalTitle'>{newArrivalData[1]?.TitleLine}</p>
//                                 <p className='mala_nwArrivalTitle'><span
//                                     className="mala_currencyFont"
//                                     dangerouslySetInnerHTML={{
//                                         __html: decodeEntities(
