    ...
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="Hoq3_CartCusto_R-details">
          <p className='Hoq3_cart-Titleline'>{selectedItem?.designno != "" && selectedItem?.designno}{selectedItem?.TitleLine != "" && " - " + selectedItem?.TitleLine}</p>
        ...
        <div className="Hoq3_CartCusto_R-details">
          <p className='Hoq3_cart-Titleline'>{selectedItem?.TitleLine}</p>
          <Divider className='Hoq3_dividerline' />
