    ...
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="smr3_CartCusto_R-details">
          <p className='smr3_cart-Titleline'>{selectedItem?.designno != "" && selectedItem?.designno}{selectedItem?.TitleLine != "" && " - " + selectedItem?.TitleLine}</p>
        ...
        <div className="smr3_CartCusto_R-details">
          <p className='smr3_cart-Titleline'>{selectedItem?.TitleLine}</p>
          <Divider className='smr3_dividerline' />
