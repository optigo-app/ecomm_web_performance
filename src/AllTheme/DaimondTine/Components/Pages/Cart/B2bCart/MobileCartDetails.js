      ...
      <div className="dtMo_cart-container" style={{ background: "#fff", padding: '20px', position: "relative" }}>
        ...
        <>
          {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
            <div className="dtMo_Cart_R-details">
              <p className='dtMo_cart-Titleline'>{formatTitleLine(selectedItem?.TitleLine) && selectedItem?.TitleLine}</p>
              <Divider />
              {storeInitData?.IsProductWebCustomization == 1 &&
                <div className="dtMo_Cart-options">
              ...
              <div className='dtMo_cartQtyPricemainDev'>
                ...
                {storeInitData?.IsPriceShow == 1 &&
                  <div className="product-price">
                    {!ispriceloding ? (
                      ...
                      <Skeleton className='dtMo_CartSkelton' variant="text" width="80%" animation="wave" />
                    )}
                  </div>
                }
              </div>
              <div className='dtMo_UpdateCartBtn'>
                <Button className="dtMo_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</Button>
              </div>
              <div className='dtMo_CloseIcon' onClick={handleClose}>
                <CloseIcon />
              </div>
            </div>
          ) :
            <div className="dtMo_CartCusto_R-details">
              <p className='dtMo_cart-Titleline'>{formatTitleLine(selectedItem?.TitleLine) && selectedItem?.TitleLine}</p>
              <Divider />
              <div className="dtMo_StockCart-options">
              ...
              <div className="dtMo_stockPriceQtyDiv">
                ...
                <div className=''>
                  {storeInitData?.IsPriceShow == 1 &&
                    <div className="dtMo_Stockproduct-price">
                      {!ispriceloding ? (
                        <span>
                          {loginInfo?.CurrencyCode ??
                            storeInitData?.CurrencyCode}{" "}
