    ...
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="dt_CartCusto_R-details">
          ...
          <div className='dt_cartQtyPricemainDev'>
            ...
            {storeInitData?.IsPriceShow == 1 &&
              <div className="product-price">
                {!ispriceloding ? (
                  ...
                  <Skeleton className='dt_CartSkelton' variant="text" width="80%" animation="wave" />
                }
              </div>
            }
          </div>
          <div className='dt_UpdateCartBtn'>
            <button className="dt_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</button>
          </div>
        </div>
      ) :
        <div className="dt_CartCusto_R-details">
          ...
          <div className="dt_stockPriceQtyDiv">
            ...
            <div className=''>
              {storeInitData?.IsPriceShow == 1 &&
                <div className="dt_Stockproduct-price">
                  {!ispriceloding ? (
                    <span>
                      {/* <span
                        className="dt_currencyFont"
