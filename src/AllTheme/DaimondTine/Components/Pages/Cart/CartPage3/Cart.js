...
const CartPage = () => {
  ...
  return (
    <div className='dt3_MainBGDiv'>
      {isMobileScreen &&
        <div className="dt3_cart-title">Cart</div>
      }
      <div className='cartMainPageDiv'>
        <div className="cartBtnGroupMainDiv">
          {!isloding && cartData.length !== 0 &&
            <div className='dt3_cartButton-groups'>
              <Link
                className='dt3_ReomoveAllCartbtn'
                variant="body2"
            ...
            <div className="dt3_cart-title">My Cart</div>
          }
          {!isloding && cartData.length !== 0 &&
            <div className='dt3_placeOrderMainbtnDivs'>
        ...
        {!isloding ? (
          <>
            ...
            {!isloding && cartData.length != 0 ? (
              <div className="dt3_cartMainPage">
                <div className="dt3_cart-left-sides">
                  <CartList
                    items={cartData}
                ...
                <div className="dt3_cart-right-side">
                  {isLargeScreen ? (
                    <div className='dt3_pc-cartDetail'>
                      {selectedItem && (
                        <CartDetails
                    ...
                    <div className='dt3_mobile-cartDetails'>
                      <MobileCartDetails
              ...
              <div className='dt3_noCartlistData'>
                <p className='dt3_title'>No Data Found!</p>
                <p className='dt3_desc'>Please First Add Product in Cart</p>
                <button className='dt3_browseOurCollectionbtn' onClick={handelMenu}>Browse our collection</button>
              </div>
            }
          </>
        ) :
