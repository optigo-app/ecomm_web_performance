  ...
  return (
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="dt3_CartCusto_R-details">
          <p className='dt3_cart-Titleline'>{selectedItem?.designno != "" && selectedItem?.designno}{selectedItem?.TitleLine != "" && " - " + selectedItem?.TitleLine}</p>
          <Divider className='dt3_dividerline' />
          {storeInitData?.IsProductWebCustomization == 1 &&
            <div className="dt3_Cart-options">
          ...
          <div className='dt3_cartQtyPricemainDev'>
            ...
            {storeInitData?.IsPriceShow == 1 &&
              <div className="product-price">
                {!ispriceloding ? (
                  <span>
                    <span className="dt3_currencyFont">{loginInfo?.CurrencyCode ?? storeInitData?.CurrencyCode}</span>&nbsp;
          ...
          <div className='dt3_UpdateCartBtn'>
            <button onClick={() => handleUpdateCart(selectedItem)}>Save</button>
          </div>
        </div>
      ) :
        <div className="dt3_CartCusto_R-details">
          <p className='dt3_cart-Titleline'>{selectedItem?.TitleLine}</p>
          <Divider className='dt3_dividerline' />
          {selectedItem?.Sol_StockNo != "" &&
            <div className='dt3_diaTitleLine'>
              <span>
                {diadata?.carat}{" "}
          ...
          <div className="dt3_StockCart-options">
          ...
          <div className="dt3_stockPriceQtyDiv">
            ...
            <div>
              {storeInitData?.IsPriceShow == 1 &&
                <div className="dt3_Stockproduct-price">
                  {!ispriceloding ? (
                    <span>
                      {loading == false &&
                        <>
