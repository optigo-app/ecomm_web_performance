...
const AccountLedger = () => {
  ...
  return (
    <div className='ledger_Account_DT'>
        <div>
                        ...
                        <tbody className='fs_td'>
                                    ...
                                    return(
                                     <>
                                     {
                                        ...
                                        <td className='border-end p-1 text-start ps-1 '>{e?.IsDebit === 0 ? '' : e?.referenceno === '' ? e?.voucherno : e?.referenceno}</td>
