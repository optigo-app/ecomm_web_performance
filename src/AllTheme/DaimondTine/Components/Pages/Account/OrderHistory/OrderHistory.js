    ...
    <div>
      ...
      {orderInfo === e?.id ? (
        ...
        ''
            ...
            }) : <span className="w-100 d-flex justify-content-center align-items-center fs-5" style={{ marginTop: '5%', marginBottom:'5%' }}>Data Not Present</span>}
        </div>
      )}
