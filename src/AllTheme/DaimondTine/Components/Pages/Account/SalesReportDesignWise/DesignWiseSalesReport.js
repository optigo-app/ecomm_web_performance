...
import "./DesignWiseSalesReportDT.scss"
...
// import jsonData from "../../../../../../utils/JsonData/DesignWiseSalesReport";
import jsonData from "../../../../../../utils/JsonData/AccountDesignWiseSales.json"
...
const handleBlurGrossWt = (index) => (event) => {
    ...
    return (
        <div className='designWiseSalesReport_Account_DT'>
