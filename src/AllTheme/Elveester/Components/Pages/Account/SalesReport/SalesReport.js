    ...
    <div className="salesReport_Account_elvee">
      <div className="elvee_fs_pt">
        <Box>
          ...
          <Box sx={{ paddingRight: "15px", paddingBottom: "20px" }}>
            <Button variant="contained" className="muiSmilingRocksBtn" sx={{ padding: "7px 10px", minWidth: "max-content", background: "#7d7f85", }} onClick={(eve) => handleSearch( eve, searchVal, fromDate, toDate, grossWtInput?.from, grossWtInput?.to ) } >
