...
const Elveester_app = () => {
  ...
  // Move the state updates into a useEffect hook to avoid issues during render
  useEffect(() => {
    ...
    // Update the timer and modal state if necessary
  ...
  }, [location?.pathname, loginData, el_setCompanyTitleLogo, el_setCompanyTitleLogoM, timerData, setRedModal]);
  ...
  return (
    <div>
      ...
      <Routes>
        ...
        <Route path="/ContinueWithEmail" element={!islogin && <ContinueWithEmail />} />
        <Route path="/ContimueWithMobile" element={!islogin && <ContimueWithMobile />} />
        <Route path="/LoginWithEmail" element={!islogin && <LoginWithEmail />} />
        <Route path="/Register" element={!islogin && <Register />} />
        <Route path="/LoginWithEmailCode" element={!islogin && <LoginWithEmailCode />} />
        <Route path="/LoginWithMobileCode" element={!islogin && <LoginWithMobileCode />} />
