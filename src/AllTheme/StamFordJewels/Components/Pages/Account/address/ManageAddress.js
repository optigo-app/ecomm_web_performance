...
const ManageAddress = () => {
    ...
    const setDefaultAddress = useSetRecoilState(stam_defaultAddressState);
 ...
 <ToastContainer  style={{
            ...
            <p style={{
                ...
                <Box sx={{ paddingLeft: "15px" }}>
                    <Button className='stam_muiSmilingRocksBtnManage savedAddressManageBtn' variant="contained" sx={{ background: "#7d7f85", padding: "6px 15px", textAlign: "end", fontSize: "0.9rem", marginBottom: "10px", marginTop: '18px', borderRadius: "0" }} onClick={() => handleOpen('', null, 'add')}>ADD NEW ADDRESS</Button></Box>
                <RadioGroup
                                    ...
                                    return <Box className="AddressSec" key={index}>
                                        <Box className={`manageAddressBlock ${item.isdefault === 1 && `manageAddressDefault`}`}>
                                            ...
                                            <Box className="addresDetailsTg addresDetailsBtn" sx={{ borderTop: "1px solid rgba(0, 0, 0, 0.04) !important", display: "flex", flexWrap: "wrap", paddingTop: "20px", position: 'absolute', bottom: 0, left: "15px", width: "calc( 100% - 30px)", }}>
                                                <Button className='stam_muiSmilingRocksBtnManageEdit' variant="contained"
                                                    sx={{
                                                ...
                                                >Edit</Button>
                                                { item.isdefault !== 1 && <Button className='stam_muiSmilingRocksBtnManageEdit'
                                                    variant="contained"
                                                    sx={{
                    ...
                    <div className='smilingAddressPopupMain'>
                        ...
                        <form onSubmit={(event) => handleSubmit(event)} style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                            <TextField
                                ...
                                label="First Name"
                                variant="outlined"
                                className="labgrowRegister_stam"
                                style={{ margin: '15px' }}
                            ...
                            <div style={{ display: 'flex', justifyContent: 'center', marginTop: '15px' }}>
                                <div style={{ display: 'flex', justifyContent: 'center', marginTop: '15px', marginBottom: '30px' }}>
                                    <button type="submit" className='stam_smilingDeleveryformSaveBtn'>{isEditMode ? 'Edit' : 'Add'}</button>
                                    <button onClick={handleClose} className='stam_smilingDeleveryformCansleBtn'>
                                        Cancel
                                    </button>
                                </div>
                            </div>
