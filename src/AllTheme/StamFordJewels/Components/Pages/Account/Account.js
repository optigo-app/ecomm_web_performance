...
import { stam_loginState } from "../../../Components/Recoil/atom";
...
function CustomTabPanel(props) {
  ...
  return (
    ...
    >
      {value === index && (
        <Box sx={{ p: 3 }} className="acc_stam_tab_p_0" style={{ marginTop: '10px !important' }}>
      ...
      <div className="accountPagTabSection">
        <div>
          <div className="stam-AccountMain">
            <div className={` ${!isSticky ? 'sticky_header_web_sm_stam_isSticky' : 'sticky_header_web_sm_stam'}`} style={{
              top: !isSticky && '0px',
            }}>
            ...
            <div className="stam-AccountTabMain">
              <Box sx={{ width: "100%" }}>
                {/* <div className='stamAccountTabWebView'>
                                  <Box sx={{ display: 'flex', justifyContent: 'center', borderBottom: 1, borderColor: 'divider' }}>
                                      <Tabs value={value} onChange={handleChange} aria-label="basic tabs example"  >  
                                          <Tab label="Your Profile" {...a11yProps(0)} />
                                          <Tab label="ORDER HISTORY" {...a11yProps(1)} />
                              ...
                              <div className='stamAccountTabMobileView YourAccountPageTabs'>
                                  <Box sx={{ display: 'flex', justifyContent: 'flex-start' }}>
                                      <Tabs value={value} orientation="vertical" onChange={handleChange} sx={{ width: '100%' }} >   
                                          <Tab label="Your Profile" {...a11yProps(0)} sx={{ textAlign: 'start', width: '90%', borderColor: 'divider' }} />
                                          <Tab label="ORDER HISTORY" {...a11yProps(1)} />
                ...
                {accountValidation() && (
                  ...
                  >
                    <Box sx={{ borderBottom: 1, borderColor: "divider" }}>
                      <Tabs
                        value={value1}
                        className="accountTabSection account_themewise_stam"
                        variant="scrollable"
