...
const MobileCartDetails = ({
  ...
  return (
    <Modal open={open} onClose={handleClose} className="stam3Mo_cart-modal" sx={{ height: '100%', overflow: 'auto' }}>
      <div className="stam3Mo_cart-container" style={{ background: "#fff", padding: '20px', position: "relative" }}>
        <div className="stam3Mo_Cart-imageDiv">
          {imageSrc === undefined ? (
            <CardMedia
        ...
        <>
          {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
            <div className="stam3Mo_Cart_R-details">
              ...
              <div className='stam3Mo_cartQtyPricemainDev'>
                ...
                {storeInitData?.IsPriceShow == 1 &&
                  <div className="product-price">
                    {!ispriceloding ? (
                      ...
                      <Skeleton className='stam3Mo_CartSkelton' variant="text" width="80%" animation="wave" />
                    )}
                  </div>
                }
              </div>
              <div className='stam3Mo_UpdateCartBtn'>
                <Button className="stam3Mo_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</Button>
              </div>
              <div className='stam3Mo_CloseIcon' onClick={handleClose}>
                <CloseIcon />
              </div>
            </div>
          ) :
            <div className="stam3Mo_CartCusto_R-details">
              ...
              <div className="stam3Mo_stockPriceQtyDiv">
                ...
                <div className=''>
                  {storeInitData?.IsPriceShow == 1 &&
                    <div className="stam3Mo_Stockproduct-price">
                      {!ispriceloding ? (
                        <span>
                          {loginInfo?.CurrencyCode ??
                            storeInitData?.CurrencyCode}{" "}
