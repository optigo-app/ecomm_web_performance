    ...
    <>
      {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
        <div className="stam_CartCusto_R-details">
          ...
          <div className='stam_cartQtyPricemainDev'>
          ...
          <div className='stam_UpdateCartBtn'>
            <button className="stam_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</button>
          </div>
        </div>
      ) :
        <div className="stam_CartCusto_R-details">
