      ...
      <div className="stamMo_cart-container" style={{ background: "#fff", padding: '20px', position: "relative" }}>
        ...
        <>
          {(selectedItem?.StockId == 0 && selectedItem?.IsMrpBase == 0) ? (
            <div className="stamMo_Cart_R-details">
              <p className='stamMo_cart-Titleline'>{formatTitleLine(selectedItem?.TitleLine) && selectedItem?.TitleLine}</p>
              <Divider />
              {storeInitData?.IsProductWebCustomization == 1 &&
                <div className="stamMo_Cart-options">
              ...
              <div className='stamMo_cartQtyPricemainDev'>
                ...
                {storeInitData?.IsPriceShow == 1 &&
                  <div className="product-price">
                    {!ispriceloding ? (
                      ...
                      <Skeleton className='stamMo_CartSkelton' variant="text" width="80%" animation="wave" />
                    )}
                  </div>
                }
              </div>
              <div className='stamMo_UpdateCartBtn'>
                <Button className="stamMo_cartUpdate-button" onClick={() => handleUpdateCart(selectedItem)}>Save</Button>
              </div>
              <div className='stamMo_CloseIcon' onClick={handleClose}>
                <CloseIcon />
              </div>
            </div>
          ) :
            <div className="stamMo_CartCusto_R-details">
              <p className='stamMo_cart-Titleline'>{formatTitleLine(selectedItem?.TitleLine) && selectedItem?.TitleLine}</p>
              <Divider />
              <div className="stamMo_StockCart-options">
              ...
              <div className="stamMo_stockPriceQtyDiv">
                ...
                <div className=''>
                  {storeInitData?.IsPriceShow == 1 &&
                    <div className="stamMo_Stockproduct-price">
                      {!ispriceloding ? (
                        <span>
                          {loginInfo?.CurrencyCode ??
                            storeInitData?.CurrencyCode}{" "}
