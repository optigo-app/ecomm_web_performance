      ...
      {storeinit?.IsPLW == 0 &&
        <>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div className='lov_footerIconeImageMain' style={{ display: 'flex', justifyContent: 'center', gap: '40px', paddingBottom: '12px' }}>
              <img src={data?.image?.[0]} className='lov_footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
              <img src={data?.image?.[1]} className='lov_footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
              <img src={data?.image?.[2]} className='lov_footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
              <img src={data?.image?.[3]} className='lov_footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
              <img src={data?.image?.[4]} className='lov_footerIconeImages' style={{ height: '80px', cursor: 'pointer', paddingBlock: '10px' }} />
            </div>
          </div>
        </>
      }
